...
/** Root productions. */
 ...
 /*@bgen(jjtree) parseScript */
  ...
  final public OServerStatement
  parseServerStatement() throws ParseException {
...
Token token;
 ...
 /*@bgen(jjtree) AlterSecurityPolicyStatement */
  ...
  private int jj_la;
  private int jj_gen;
  final private int[] jj_la1 = new int[434];
