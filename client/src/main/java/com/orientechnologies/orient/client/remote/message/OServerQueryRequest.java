...
public final class OServerQueryRequest implements OBinaryRequest<OServerQueryResponse> {
  ...
  public OServerQueryRequest(String language, String iCommand, Object[] positionalParams, byte operationType,
...
//    }
  ...
  public OServerQueryRequest(String language, String iCommand, Map<String, Object> namedParams, byte operationType,
                             ORecordSerializer serializer, int recordsPerPage) {
    this.language = language;
    this.statement = iCommand;
